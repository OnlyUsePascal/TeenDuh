package com.example.teenduh.Adapter;
...
public class listOrientationAdapter extends RecyclerView.Adapter<listOrientationAdapter.ViewHolder> {
    private List<ListOfSexualOrientation> listOrientation;
    private View mView;
    public int selectionsCount = 0;
    public listOrientationAdapter(List<ListOfSexualOrientation> listOrientation, View mView) {
        this.listOrientation = listOrientation;
        this.mView = mView;
    }
    @NonNull
    @Override
    public listOrientationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_orientation_layout, parent, false);
        return new listOrientationAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull listOrientationAdapter.ViewHolder holder, int position) {
        ListOfSexualOrientation option = listOrientation.get(position);
