...
public class WelcomeAdapter extends RecyclerView.Adapter<WelcomeAdapter.ImageViewHolder>{
  private List<Image> imageList;
  private ViewPager2 viewPager2;

  public WelcomeAdapter(List<Image> imageList, ViewPager2 viewPager2){
